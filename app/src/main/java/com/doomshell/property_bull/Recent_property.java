...
import com.doomshell.property_bull.adapter.RecentProperty_MoreAdapter;
...
public class Recent_property extends Fragment {
    Context context;
    View convertview;
    String userid;
    ...
    RecentProperty_MoreAdapter mAdapter;
    private List<Recent_p> mItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        screentitle.setText("Recent Property");
...
//bar.setProgress()
    ...
    void load_recentprojects() {
        ...
        show_dialogue();
        serverapi.recent_properties(new Callback<Response>() {
            @Override
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; i < products.length(); i++) {
                            ...
                            String room = c.getString("room").trim();
                    ...
                    /*    adapter = new Recent_Property_adapter(context, pid_list,pname_list,ppostedby_list,pmobile_list,ptype_list,pbedroom_list,
                        ...
                        mAdapter = new RecentProperty_MoreAdapter(context, pid_list, pname_list, ppostedby_list, pmobile_list, ptype_list, pbedroom_list,
                                ptotalarea_list, ptotalprice_list, ppriceperunit_list, pimage_list, getActivity());
    ...
    private void loadMoreData() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                List<Recent_p> newItems = getData(mItems.size());
    ...
    private List<Recent_p> getData(int start) {
        List<Recent_p> items = new ArrayList<>();
        for (int i = start; i < start + 8; i++) {
            items.add(new Recent_p(i));
        }
