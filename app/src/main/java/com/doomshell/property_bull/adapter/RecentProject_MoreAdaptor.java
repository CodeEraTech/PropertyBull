...
public class RecentProject_MoreAdaptor extends RecyclerView.Adapter<RecentProject_MoreAdaptor.MyViewHolder> {
    ...
    public RecentProject_MoreAdaptor(Context context,
