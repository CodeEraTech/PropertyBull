...
public class Search_Property_usertypeadapter extends RecyclerView.Adapter<Search_Property_usertypeadapter.MyViewHolder> {
   ...
   public static int CallState=101;
    ...
    public Search_Property_usertypeadapter(Context context,
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.search_property_addedbycardview, parent, false);
...
*/
                ...
                bundle.putString("ppostedby_list", addedusername.get(position));
                ...
                bundle.putString("latitude", "18.520430");
                bundle.putString("longitude", "73.856743");
     ...
     //   id_text.setText("" + pid_list.get(position));
        ...
        holder.addedby.setText(addedusertype.get(position)+" : "+addedusername.get(position));
        ...
        favstar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               favstar.setColorFilter(new
                ...
                SharedPrefManager.getInstance(context).savefav_property("postedby"+position,""+addedusername.get(position));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView cardView;
        TextView locality,c_Propertid,addedby;
       // ProgressBar pb;
