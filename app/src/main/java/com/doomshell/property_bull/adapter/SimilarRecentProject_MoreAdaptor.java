...
public class SimilarRecentProject_MoreAdaptor extends RecyclerView.Adapter<SimilarRecentProject_MoreAdaptor.MyViewHolder> {
    ...
    public SimilarRecentProject_MoreAdaptor(Context context,
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.search_project_cardview, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final ProgressBar pb = holder.recent_img_progress;
...
*/
                ...
                bundle.putString("ptotalarea_list", ptotalarea_list.get(position).trim());
        ...
        holder.c_Propertid.setVisibility(View.VISIBLE);
        holder.c_Propertid.setText("ID : " + pid_list.get(position));
        name_text.setText("" + pname_list.get(position));
        state_text.setText("" + type_list.get(position));
        if (ptotalarea_list.get(position).contains("-")) {
            city_text.setText("" + ptotalarea_list.get(position).split("\\-")[0].trim() + " " + ppriceperunit_list.get(position));
        } else {
            city_text.setText("" + ptotalarea_list.get(position) + " " + ppriceperunit_list.get(position));
        }
        adapter_price.setText("\u20B9 " + ptotalprice_list.get(position));
        holder.locality.setText(locality_list.get(position).toString());
